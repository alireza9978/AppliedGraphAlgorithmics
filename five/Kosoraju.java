...
public class Kosoraju extends DGraphWtAL {
    ...
    public static class KosorajuOutput{

        int component_count;
        int[] components;

        public KosorajuOutput(int component_count, int[] components) {
            this.component_count = component_count;
            this.components = components;
        }
    }
    public KosorajuOutput SCC() {
        reset(-1);
        ...
        return new KosorajuOutput(component_number, component);
    }
